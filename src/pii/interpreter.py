...
class PiiInterpreter(code.InteractiveConsole):
	...
	def get_local_dir(self, local_key):
		local_dir = []
		# NEED TO HANDLE MODULES WITH MORE THAN ONE LEVEL, can use getattr(moduleobj, "module path") to get the latest module object
...
def piidisplayhook(value):
	if value is not None:
		...
		# TODO: Need to figure out the above code for
		# python 3 - look at docs for sys.displayhooks
		pprint.pprint(value)
